...
Trabalhar com structs e estruturas de dados

Implementar manipulação de arquivos binários

Aplicar modularização de código em C
...
Desenvolvido para disciplina de Estrutura de Dados
